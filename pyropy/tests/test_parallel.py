...
def test_parallel_scheme(reactions: ReactManager):
    ...
    test.solve_system()
    solution_known = np.array([100., 99.98303254, 99.41627862, 96.87519857, 95.41962767,
                               95.00241108, 93.79111514, 90.68643543, 88.25904679, 86.96281349,
                               86.26421096, 85.86255122, 85.61696297, 85.45879965, 85.35238839])
